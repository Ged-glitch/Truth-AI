...
function renderAuthControls() {
  ...
  badge.style.cssText =
    "display:inline-flex;align-items:center;gap:8px;font-size:13px;font-weight:600;color:#0f172a;padding:9px 12px;border:1px solid #d4dde8;border-radius:9px;background:#fff;white-space:nowrap;";
  ...
  signOut.style.cssText =
    "font:inherit;font-size:14px;font-weight:600;color:#0f172a;padding:9px 14px;border:1px solid #d4dde8;border-radius:9px;background:#fff;cursor:pointer;white-space:nowrap;";
